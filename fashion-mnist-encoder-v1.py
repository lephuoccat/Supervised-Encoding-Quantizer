...
dataset_size = 60000
#dataset = trainset = FashionMNIST('./data', download=True, train=True, transform=transform)
#datasetloader = DataLoader(dataset, batch_size=32, shuffle=False)
#datasetloader = DataLoader(trainset, batch_size=dataset_size, shuffle=False, sampler=torch.utils.data.sampler.SubsetRandomSampler(list(range(dataset_size))))
